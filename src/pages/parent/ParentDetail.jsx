...
function ParentDetail() {
  ...
  return (
    <div className="w-full min-h-screen p-4">
      <div className="mb-6">
        <h1 className="text-2xl md:text-3xl font-bold text-primary font-heading">ข้อมูลผู้ปกครอง</h1>
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-medium text-text-color font-heading">{parent.name}</h2>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-lg font-medium text-text-color">{parent.name}</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                {parent.email ? (
                  ...
                  <p className="text-lg font-medium text-text-color-alt italic">ไม่มีอีเมล</p>
                )}
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                {parent.tel ? (
                  ...
                  <p className="text-lg font-medium text-text-color-alt italic">ไม่มีเบอร์โทรศัพท์</p>
                )}
              </div>
            </div>            {parent.lineId && (
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-text-color">{parent.lineId}</p>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="mb-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-800">นักเรียนในปกครอง</h2>
          </div>

...
function CreateClassroom() {
  ...
  const handleTeacherChange = (selectedOptions, formIndex = null) => {
    const fieldName =
      formIndex !== null ? `classroom_${formIndex}.teacherIds` : "teacherIds";
    const previousTeachers = watch(fieldName) || [];
    const newTeacherIds = selectedOptions
  ...
  const ClassroomForm = ({ index }) => {
    ...
    const currentTeacherIds =
      useWatch({ control, name: `classroom_${index}.teacherIds` }) || [];
    const formTerm = useWatch({ control, name: `classroom_${index}.termId` });
    const classTypeOptions =
      classroomType?.map((ct) => ({
    ...
    return (
      <div className="border border-gray-200 p-5 rounded-lg bg-gray-50">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-text-color font-medium font-heading">
            ...
            <Controller
              ...
              render={({ field }) => (
                <Select
                  ...
                  value={
                    classTypeOptions.find((opt) => opt.value === field.value) ||
                    null
                  }
            ...
            <Controller
              ...
              render={({ field }) => (
                <Select
                  ...
                  options={termOptions}
                  value={
                    termOptions.find((opt) => opt.value === field.value) || null
                  }
                  onChange={(selectedOption) => {
                    const term = academicterms?.find(
                      (t) => t.termId === selectedOption?.value
                    );
                    if (term) {
                      setValue(
                        `classroom_${index}.academicYear`,
                        term.academicYear
                      );
              ...
              render={({ field }) => (
                <Select
                  ...
                  options={teacherOptions?.filter(
                    (opt) =>
                      (!opt.classTeacher.some(
                        (ct) => ct.classroom.termId === formTerm
                      ) ||
        ...
        <div className="p-6">
          ...
          <div className="mb-6 bg-gray-50 p-4 rounded-lg border border-gray-100">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <span className="text-text-color font-medium font-body">
                สร้างหลายห้องเรียน
              </span>
            </label>
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    onClick={() =>
                      setNumberOfClassrooms((prev) => Math.max(1, prev - 1))
                    }
                    className="px-3 py-1 border rounded-md hover:bg-gray-100 transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-4 w-4 text-text-color"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    options={
                      academicterms?.map((term) => ({
                        value: term.termId,
                        label: `ปีการศึกษา ${term.academicYear + 543} เทอม ${
                          term.semester
                        }`,
                      })) || []
                    }
                  ...
                  <Select
                    ...
                    options={teacherOptions?.filter(
                      (opt) =>
                        ...
                        (!opt.classTeacher.some(
                          (ct) => ct.classroom.termId === selectedTerm
                        ) ||
                    ...
                    onChange={(selectedOptions) =>
                      handleTeacherChange(selectedOptions)
                    }
                    isClearable
                    isMulti
                    placeholder="เลือกครูที่ปรึกษา..."

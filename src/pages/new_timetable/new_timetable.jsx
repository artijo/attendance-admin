                                        ...
                                        return(
                                            <td key={`${time} period ${period+1}`} className="p-1">
                                                <div 
                                                    ...
                                                    className="card cursor-pointer flex justify-center items-center w-40 h-20 bg-gray-200 rounded-lg hover:bg-gray-300 hover:ring-2 hover:shadow-md hover:text-gray-500"
                                                >
                                        ...
                                        return (
                                            <td key={`${time} period ${period+1}`} className="p-1">
                                                <div 
                                                    ...
                                                    className="cursor-pointer card grid grid-cols-1 gap-1 w-40 h-20 bg-background-alt rounded-lg p-2 text-white hover:ring-2"
                                                >

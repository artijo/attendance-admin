...
function FilterClassroomPage() {
    ...
    const handleViewPDF = (classroom) => {
        ...
        setTimeout(() => {
            navigate("/activity/participate/filterbyclassroom/pdfpage", {
                state: {
            ...
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-text-color-alt font-body">การเข้าร่วมกิจกรรมแบ่งตามห้องและวัน</p>
                    </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-line overflow-hidden">
                <div className="p-6">
                    {classrooms.length > 0 ? (
                        <>
                            <div className="mb-6">
                                <h3 className="text-lg font-medium text-text-color font-heading mb-4 flex items-center">

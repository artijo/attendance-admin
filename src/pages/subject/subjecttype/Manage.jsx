    ...
    <div className="min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
        {subjectTypes.length > 0 && (
          <div className="mb-3 sm:mb-0 bg-white rounded-lg px-4 py-2 border border-line shadow-sm">
            <span className="text-text-color-alt font-body">จำนวนกลุ่มสาระการเรียนรู้ทั้งหมด:</span>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-xl shadow-md p-8 text-center border border-line">
          ...
          <h2 className="text-xl font-semibold text-text-color mb-2 font-heading">ไม่พบข้อมูลกลุ่มสาระการเรียนรู้</h2>
          <p className="text-text-color-alt font-body">กรุณาเพิ่มข้อมูลกลุ่มสาระการเรียนรู้</p>
        </div>
      ) : (
            ...
            <table className="w-full text-sm text-left">
              <thead className="text-xs text-text-color-alt font-medium uppercase tracking-wider bg-gray-50 border-b border-line">
                <tr>
                  ...
                  <th className="px-6 py-4">ชื่อกลุ่มสาระการเรียนรู้ (อังกฤษ)</th>
                  <th className="px-6 py-4 text-center" width="180">จัดการ</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                {subjectTypes.map((type) => (
                  <tr key={type.subTypeId} className="hover:bg-gray-50 transition-colors duration-150">
                    <td className="px-6 py-4 font-medium text-text-color">{type.subTypeNameThai}</td>
                    <td className="px-6 py-4 text-text-color-alt">{type.subTypeNameEng}</td>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md border border-line">
            <div className="text-center mb-5">
              ...
              <p className="text-text-color-alt font-body">
                คุณต้องการลบกลุ่มสาระการเรียนรู้ "{subjectTypeToDelete?.subTypeNameThai}" ใช่หรือไม่?
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-text-color font-body flex items-center">
                    ...
                    ชื่อกลุ่มสาระการเรียนรู้ (ไทย) <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-text-color font-body flex items-center">
                    ...
                    ชื่อกลุ่มสาระการเรียนรู้ (อังกฤษ) <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"

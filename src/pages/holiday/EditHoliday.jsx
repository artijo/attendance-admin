...
function EditHoliday() {
    ...
    return (
        <div className="min-h-screen">
            <div className="mb-6">
                <h1 className="text-2xl md:text-3xl font-bold text-primary font-heading">แก้ไขข้อมูลวันหยุด</h1>
            ...
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-text-color-alt font-body">ปรับปรุงข้อมูลวันหยุด</p>
                    </div>
                </div>

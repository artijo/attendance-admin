        ...
        >
            ...
            {clicked && (
                ...
                >
                    <ul className="p-1">
                        <li 
                            className="p-1 flex gap-2 group/item items-center text-sm hover:cursor-pointer hover:bg-gray-300 rounded-md"
                        ...
                        <li className="p-1 flex gap-2 group/item  items-center  text-sm hover:cursor-pointer hover:bg-gray-300 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
            ...
            {deleteDiologShow && (
                <DeleteDialog
                    callApi = {callDeleteTimetableApi}
                    setDeleteDiologShow = {setDeleteDiologShow(false)}
                />
            )}
        </div>
    );

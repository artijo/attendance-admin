  ...
  const handleDeleteHoliday = async () => {
    ...
    try {
      ...
      const response = await axios.delete(
        `${HOSTNAME}/a/holiday/${holidayToDelete.id}`,
      );
        ...
        <table className="w-full border-collapse">
          <thead className="bg-gray-50 border-b border-line">
            <tr>
              ...
              <th
                className="px-4 py-3.5 text-center text-xs font-medium text-text-color-alt tracking-wider font-heading"
                width="150"
              >
                จัดการ
              </th>
                ...
                <td colSpan={5} className="py-8">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-text-color-alt font-body">
                      ยังไม่มีข้อมูลวันหยุดในเทอมที่เลือก
                    </p>
                  </div>
                </td>
              </tr>

  ...
  return (
    ...
    <dl className="-my-3 divide-y divide-gray-100 text-sm">
      ...
      <div className="grid grid-cols-1 gap-1 p-3 sm:grid-cols-3 sm:gap-4">
        ...
        <dd className="text-gray-700 sm:col-span-2">{student.fName} {student.lName}</dd>
      </div>
  
      <div className="grid grid-cols-1 gap-1 p-3 sm:grid-cols-3 sm:gap-4">
        <dt className="font-medium text-gray-900">ชั้นมัธยมศึกษาปีที่</dt>
        <dd className="text-gray-700 sm:col-span-2">{student.classroomMembers[0].classroom.classLevel}</dd>
      </div>
